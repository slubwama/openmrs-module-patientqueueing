...
public class PatientQueueingServiceImpl extends BaseOpenmrsService implements PatientQueueingService {
    ...
    public List<PatientQueue> getPatientInQueueList(Provider provider, Date fromDate, Date toDate, Location sessionLocation) throws APIException {
        return dao.getPatientInQueue(provider, fromDate, toDate, sessionLocation);
    }

    public List<PatientQueue> getPatientInQueueList(Provider provider, Date fromDate, Date toDate, Location sessionLocation, Patient patient, String status) throws APIException {
        return dao.getPatientInQueue(provider, fromDate, toDate, sessionLocation, patient, status);
    }

    @Override
    public List<PatientQueue> getPatientInQueueList(Date fromDate, Date toDate, Location sessionLocation) throws APIException {
    ...
    @Override
    public List<PatientQueue> searchQueue(String searchString, String fromDate, String toDate, Provider provider, Location sessionLocation) throws APIException {
    ...
    public List<PatientQueue> getPatientQueueList(String searchString, Date fromDate, Date toDate, Patient patient, Provider provider, Location locationTo, Location locationFrom, String status) {
        return dao.getPatientQueueList(processPatientSearchString(searchString), fromDate, toDate, patient, provider, locationTo, locationFrom, status);
    }
