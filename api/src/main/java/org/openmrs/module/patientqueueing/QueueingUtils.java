...
public class QueueingUtils {
	...
	/**
	 * This method changes the time of a date set to the time given in the time string. The Time
	 * format should be HH:mm:ss forexample 00:00:00 ,23:59:59 etc
	 * 
	 ...
	 */
	public static Date changeTimeOfDate(Date date, String time) throws ParseException {
		AdministrationService administrationService = Context.getAdministrationService();
		SimpleDateFormat formatter = new SimpleDateFormat(
		        administrationService.getGlobalProperty("patientqueueing.displayDateTimeFormat"));
	 ...
	 */
	public static String formatDateAsString(Date date, String time) {
