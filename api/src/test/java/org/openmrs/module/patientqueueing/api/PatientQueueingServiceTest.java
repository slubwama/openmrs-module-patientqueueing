...
public class PatientQueueingServiceTest extends BaseModuleContextSensitiveTest {
    ...
    public void getPatientQueueListBySearchParams_shouldReturnPatientQueuesThatMatchesParameters() throws Exception {
		...
		List<PatientQueue> patientQueueList = patientQueueingService.getPatientQueueListBySearchParams("Mukasa", OpenmrsUtil.firstSecondOfDay(date), OpenmrsUtil.getLastMomentOfDay(date), null, null, PatientQueue.Status.PENDING);
